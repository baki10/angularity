...
App.factory('PlayerService', ['$http', '$q', function($http, $q){
    ...
    return {
        ...
        fetchAllPlayers: function() {
            return $http.get('http://localhost:8080/serverApp/rest/player/')
                .then(
                    function(response){
        ...
        createPlayer: function(player){
            return $http.post('http://localhost:8080/serverApp/rest/player/', player)
                .then(
                    function(response){
                        return response.data;
                    },
        ...
        updatePlayer: function(player, id){
            return $http.put('http://localhost:8080/serverApp/rest/player/'+id, player)
                .then(
                    function(response){
                        return response.data;
                    },
        ...
        deletePlayer: function(id){
            return $http.delete('http://localhost:8080/serverApp/rest/player/'+id)
                .then(
                    function(response){
                        return response.data;
                    },
